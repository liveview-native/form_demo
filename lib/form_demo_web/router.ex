defmodule FormDemoWeb.Router do
  ...
  scope "/", FormDemoWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{FormDemoWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", FormDemoWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{FormDemoWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", FormDemoWeb do
    ...
    live_session :current_user,
      on_mount: [{FormDemoWeb.UserAuth, :mount_current_user}] do
